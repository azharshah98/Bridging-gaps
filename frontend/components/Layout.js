...
export default function Layout({ children }) {
  ...
  const navigation = [
    ...
    { name: 'Foster Carers', href: '/carers', icon: UsersIcon },
    { name: 'Referrals', href: '/referrals', icon: ClipboardIcon },
    { name: 'Matching', href: '/matching', icon: TargetIcon },
          ...
          <div className="flex-shrink-0 border-t border-gray-200">
            <div className="px-4 py-4">
              ...
              <button
                ...
                className="w-full flex items-center px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-900 rounded-md border border-gray-300 bg-white"
              >
